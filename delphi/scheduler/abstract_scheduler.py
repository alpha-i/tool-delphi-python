...
class SchedulingFrequency:
    def __init__(self, schedule_frequency, days_offset=0, minutes_offset=0):
        """
        :param schedule_frequency: Type of the scheduling frequency
        :type schedule_frequency: SchedulingFrequencyType
        :param days_offset:
        :type days_offset: int
        :param minutes_offset:
        :type minutes_offset: int
        """
        self.frequency = schedule_frequency
...
class Scheduler(AbstractScheduler):
    ...
    def _init_a_schedule(self, schedule, action):
        ...
        if schedule.type == SchedulingFrequencyType.WEEKLY:
        ...
        elif schedule.type == SchedulingFrequencyType.DAILY:
        ...
        elif schedule.type == SchedulingFrequencyType.MINUTE:
